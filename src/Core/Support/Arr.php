...
class Arr
{
    ...
    public static function pluck(array $array, array|string $value, array|string $key = null): array
    {
        ...
        foreach ($array as $item) {
            $itemValue = \_S\data_get($item, $value);
     ...
     *
     * @return array
     * @todo: test with string (func name) param
     */
    public static function sort(array $array, callable|string $callback = null): array
    {
        return Collection::wrap($array)->sort($callback)->all();
    }
     ...
     *
     * @param array $array Query params
     *
     * @return string
     */
